...
//winnner to be selected every x minutes => completly automated
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    uint32 private constant NUM_WORDS = 1; // It means how many random number i gonna request
    ...
    constructor(
        address vrfCoordiantorV2, // contract
        uint256 entranceFee,
        bytes32 gasLane,
        uint64 subscriptionId,
        uint32 callBackGasLimit,
        uint256 interval
    ) VRFConsumerBaseV2(vrfCoordiantorV2) {
